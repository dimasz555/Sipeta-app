!(function (e, t) {
    ...
    function xe(e, t) {
        ...
        var n,
            n = ((t % (n = 12)) + n) % n;
        return (
            (e += (t - n) / 12), 1 == n ? (I(e) ? 29 : 28) : 31 - ((n % 7) % 2)
        );
    }
    (we =
    ...
    function Ut(e) {
        ...
        (this._isValid = (function (e) {
            ...
            for (t in e)
                if (
                    f(e, t) &&
                    (-1 === we.call(Ct, t) || (null != e[t] && isNaN(e[t])))
                )
                    return !1;
            for (n = 0; n < i; ++n)
                if (e[Ct[n]]) {
    ...
    (ie.add = Qt),
                ...
                for (
                    var n = (function (e) {
                            var t,
                                n = [];
                            for (t in e)
                                f(e, t) && n.push({ unit: t, priority: E[t] });
                            return (
                                n.sort(function (e, t) {
        ...
        (ie.toISOString = function (e) {
            ...
            var t = !0 !== e;
            return (e = t ? this.clone().utc() : this).year() < 0 ||
                9999 < e.year()
                ? U(
                      e,
                      t
        ...
        (ie.eraYear = function () {
            for (
                ...
                if (
                    ...
                    return (
                        (this.year() - c(n[s].since).year()) * e + n[s].offset
                    );
            return this.year();
        }),
        (ie.year = Le),
